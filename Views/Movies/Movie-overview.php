        ...
        <div>
          ...
          <div class="one_half first cardStyle">              
            <div class="one_half first">
              <div><p><h4>Release Date</h4><?php echo $movie->getReleaseDate()?></p></div><br>
              <div><p><h4>Genre</h4><?php $str=""; foreach($movie->getGenreStrings() as $genre){
                                                            $str .=" ".$genre." /";}
                                                            echo substr_replace($str,"", -1); ?></p>
              </div>
            </div>
            <div class="one_half">
              <div><p><h4>Runtime</h4><?php echo $movie->getRuntime()?> minutes</p></div><br>
              <div><p><h4>Homepage</h4>
