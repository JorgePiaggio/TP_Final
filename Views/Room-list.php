                         ...
                         <table class="table bg-light">
                              ...
                              <?php foreach($roomList as $room){ ?>
                                   <tr>       
                                        ...
                                        <td><button type="submit" name="id" class="btn" value="<?php echo $room->getNumber();?>"> Edit </button></td>
                                        </form>
                                        <form action="<?php echo FRONT_ROOT?>Room/changeState" method="post">
                                        <input type="hidden" name="idcinema" value="<?php echo $room->getIdcinema();?>">
                                        <td><button type="submit" name="id" class="btn" value="<?php echo $room->getNumber();?>"> Remove </button></td>
                                        </form>
                                   </tr>
                              <?php } ?>
                              </tbody>
                         ...
                         <table class="table bg-light">
                              ...
                              <?php foreach($roomsInactives as $room){ ?>
                                   <tr>       
                                        ...
                                        <form action="<?php echo FRONT_ROOT?>Room/changeState" method="post">
                                        <input type="hidden" name="idcinema" value="<?php echo $room->getIdcinema();?>">
                                        <td><button type="submit" name="id" class="btn" value="<?php echo $room->getNumber();?>"> Restore </button></td>
                                        </form>
                                   </tr>
                              <?php } ?>
                              </tbody>
